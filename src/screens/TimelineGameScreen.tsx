...
const HISTORICAL_ERAS: Era[] = [
  {
    ...
    events: [
      ...
      { id: 'k5', year: 1353, title: 'Çimpe Kalesi’nin Alınması', desc: 'Bizans\'taki taht kavgalarına yardım karşılığı Çimpe Kalesi Osmanlı\'ya verildi.', emoji: '🏰', kpssTip: 'Osmanlı\'nın Rumeli\'ye geçişteki İLK askeri üssüdür. Orhan Bey döneminde gerçekleşmiştir. Balkan fetihlerinin sıçrama tahtasıdır.' },
      { id: 'k6', year: 1364, title: 'Sırpsındığı Savaşı', desc: 'İlk Osmanlı-Haçlı savaşı ve Haçlıların bozguna uğratılması.', emoji: '⚔️', kpssTip: 'Haçlılarla yapılan İLK savaştır. I. Murat dönemindedir. Savaşın kazanılmasıyle Edirne başkent yapılmış ve Balkan fetihleri hız kazanmıştır.' },
      { id: 'k7', year: 1389, title: 'I. Kosova Savaşı', desc: 'Haçlılara karşı kazanılan büyük zafer; Osmanlı ilk kez top kullandı.', emoji: '🛡️', kpssTip: 'I. Murat dönemindedir. İlk kez top (sesinden korkutmak amacıyla) kullanılmıştır. I. Murat savaş alanını gezerken bir Sırplı tarafından şehit edilmiştir (Savaş alanında şehit düşen İLK ve TEK padişahtır).' },
      { id: 'k8', year: 1396, title: 'Niğbolu Savaşı', desc: 'Yıldırım Bayezid\'in büyük Haçlı ordusunu imha ettiği tarihi zafer.', emoji: '🎖️', kpssTip: 'Yıldırım Bayezid\'e bu zafer üzerine Abbasi Halifesi tarafından "Sultan-ı İklim-i Rum" (Anadolu Diyarının Sultanı) unvanı verilmiştir. Bu unvan Osmanlı\'nın İslam dünyasındaki prestijini zirveye taşımıştır.' },
      { id: 'k9', year: 1402, title: 'Ankara Savaşı', desc: 'Yıldırım Bayezid ile Timur arasında yapıldı, Osmanlı yenildi ve Fetret Devri başladı.', emoji: '📉', kpssTip: 'Yıldırım Bayezid esir düşmüştür. Anadolu Türk siyasi birliği bozulmuş, beylikler yeniden kurulmuş ve Osmanlı 11 yıl sürecek "Fetret Devri" krizine girmiştir.' },
      { id: 'k10', year: 1444, title: 'Edirne-Segedin Antlaşması', desc: 'Osmanlı ile Macarlar arasında imzalanan ilk yazılı barış antlaşması.', emoji: '📜', kpssTip: 'Osmanlı\'nın batıda imzaladığı İLK sınırlayıcı antlaşmadır. II. Murat bu antlaşmaya güvenerek tahtı 12 yaşındaki oğlu II. Mehmet\'e (Fatih) bırakmıştır.' },
      { id: 'k11', year: 1444, title: 'Varna Savaşı', desc: 'Tahtı babasına bırakan II. Mehmet\'in çağrısıyla Haçlı ordusunu yok eden II. Murat zaferi.', emoji: '⚔️', kpssTip: 'Haçlıların Edirne-Segedin antlaşmasını bozması üzerine yapılmıştır. II. Murat ordunun başına geçerek Haçlıları imha etmiştir.' },
      { id: 'k12', year: 1448, title: 'II. Kosova Savaşı', desc: 'II. Murat komutasında Haçlıların kesin olarak yenilgiye uğratılması.', emoji: '🛡️', kpssTip: 'Bu zaferle Balkanlar\'ın KESİN olarak Türk yurdu olduğu tescillenmiş ve Haçlılar savunmaya, Osmanlı ise taarruza geçmiştir.' },
    ]
  },
  {
    id: 'yukselis',
    ...
    events: [
      ...
      { id: 'y3', year: 1475, title: 'Kırım\'ın Fethi', desc: 'Gedik Ahmet Paşa komutasındaki donanma Kırım\'ı fethederek Cenevizlilerden temizledi.', emoji: '🌊', kpssTip: 'Kırım\'ın alınmasıyla Karadeniz tamamen bir "Türk Gölü" haline gelmiştir. İpek Yolu\'nun kuzey kolu tamamen denetimimize geçmiştir.' },
      { id: 'y4', year: 1514, title: 'Çaldıran Savaşı', desc: 'Yavuz Sultan Selim’in Safevilere karşı kazandığı tarihi zafer.', emoji: '🛡️', kpssTip: 'Safevi (Şii) tehlikesi uzun bir süre için engellenmiş, Tebriz-Halep ipek yolu hattı kontrol altına alınmıştır.' },
      { id: 'y5', year: 1515, title: 'Turnadağ Savaşı', desc: 'Dulkadiroğulları beyliği yıkılarak Anadolu Türk birliği sağlandı.', emoji: '🤝', kpssTip: 'Yavuz Sultan Selim dönemidir. Anadolu Türk Siyasi Birliği (ATSB) KESİN olarak ve tamamen sağlanmıştır. (İlk adımı atan Karesioğulları, kesinleştiren Dulkadiroğulları\'dır).' },
      { id: 'y6', year: 1517, title: 'Ridaniye Savaşı ve Mısır Fethi', desc: 'Memlük devleti yıkıldı, Mısır fethedildi ve halifelik Osmanlı\'ya geçti.', emoji: '🕌', kpssTip: 'Yavuz Sultan Selim dönemidir. Halifelik makamı, kutsal emanetler Osmanlı\'ya geçmiş, Baharat Yolu kontrol altına alınmış ve devlet teokratik (dini) niteliğini güçlendirmiştir.' },
      { id: 'y7', year: 1521, title: 'Belgrad\'ın Fethi', desc: 'Kanuni Sultan Süleyman ilk büyük batı seferinde Belgrad\'ı fethetti.', emoji: '🏰', kpssTip: 'Fatih döneminde kuşatılıp alınamayan Belgrad alınmıştır. Avrupa\'ya yapılacak seferler için en önemli askeri üs ele geçirilmiştir.' },
      { id: 'y8', year: 1526, title: 'Mohaç Meydan Muharebesi', desc: 'Macar ordusunun 2 saatte yenildiği dünya tarihinin en kısa meydan zaferi.', emoji: '⚔️', kpssTip: 'Kanuni Sultan Süleyman dönemindedir. Macaristan Osmanlı\'ya bağlanmış ve Orta Avrupa\'da Osmanlı üstünlüğü kesinleşmiştir.' },
      { id: 'y9', year: 1538, title: 'Preveze Deniz Zaferi', desc: 'Haçlı donanmasının yenilmesiyle Akdeniz Türk gölü haline geldi.', emoji: '⛵', kpssTip: 'Barbaros Hayreddin Paşa komutasındaki zaferdir. Akdeniz tamamen bir "Türk Gölü" haline gelmiştir. Bu gün günümüzde "Türk Denizcilik Günü" olarak kutlanır.' },
      { id: 'y10', year: 1555, title: 'Amasya Antlaşması', desc: 'İran (Safeviler) ile imzalanan tarihteki ilk resmi anlaşmadır.', emoji: '📜', kpssTip: 'Kanuni dönemindedir. Safevi devleti ile yapılan İLK resmi anlaşma özelliğini taşır, sınırlar resmiyet kazanmıştır.' },
    ]
  },
  {
    id: 'duraklama',
    ...
    events: [
      ...
      { id: 'd3', year: 1606, title: 'Zitvatorok Antlaşması', desc: 'Avusturya kralı Osmanlı padişahına eşit sayıldı, siyasi üstünlük bitti.', emoji: '📜', kpssTip: 'İstanbul Antlaşması (1533) ile kurulan siyasi/protokol üstünlük sona ermiştir. Avusturya arşidükü sadrazama değil doğrudan Padişaha denk sayılmıştır (Diplomatik mütekabiliyet).' },
      { id: 'd4', year: 1621, title: 'Hotin Seferi', desc: 'Genç Osman\'ın Yeniçeri ocak disiplinsizliğini gördüğü sefer.', emoji: '🛡️', kpssTip: 'II. Osman (Genç Osman) ocağın disiplinsizliğini bizzat görerek Yeniçeri Ocağı\'nı kaldırmaya karar vermiş ancak bu durumu hayatıyla ödemiştir (İlk radikal ıslahatçı padişah).' },
      { id: 'd5', year: 1639, title: 'Kasr-ı Şirin Antlaşması', desc: 'Bugünkü Türkiye-İran sınırını büyük ölçüde belirleyen antlaşma.', emoji: '✍️', kpssTip: 'IV. Murat (Bağdat Fatihi) dönemindedir. Bugün hala yürürlükte olan ve en uzun süre değişmeden kalan sınırlarımızdan birini çizmiştir.' },
      { id: 'd6', year: 1656, title: 'Köprülü Şartlı Sadrazamlığı', desc: 'Köprülü Mehmet Paşa saraya şartlar sunarak sadrazam olmayı kabul etti.', emoji: '🤝', kpssTip: 'Osmanlı tarihinde saraya şartlar sunarak göreve gelen ilk sadrazamdır. Duraklama içinde yükselme dönemi yaşatmıştır.' },
      { id: 'd7', year: 1669, title: 'Girit’in Fethi', desc: '24 yıllık kuşatmadan sonra Venedik\'ten alınan Akdeniz adası.', emoji: '🏝️', kpssTip: 'Fazıl Ahmet Paşa komutasındadır. Fethin 24 yıl sürmesi Osmanlı donanmasının eski gücünü kaybettiğinin en büyük kanıtıdır.' },
      { id: 'd8', year: 1672, title: 'Bucaş Antlaşması', desc: 'Lehistan\'dan Podolya alınarak batıda en geniş sınırlara ulaşıldı.', emoji: '📜', kpssTip: 'Osmanlı\'nın batıda en geniş sınırlara ulaştığı antlaşmadır. Toprak kazanılan son büyük antlaşma olma niteliği taşır.' },
      { id: 'd9', year: 1681, title: 'Bahçesaray (Çehrin) Anlaşması', desc: 'Osmanlı ile Rusya arasında yapılan ilk resmi sınır antlaşmasıdır.', emoji: '📜', kpssTip: 'Rus Çarlığı ile yapılan İLK resmi anlaşmadır. Dinyeper nehri sınır olarak kabul edilmiştir.' },
      { id: 'd10', year: 1683, title: 'II. Viyana Kuşatması', desc: 'Merzifonlu Kara Mustafa Paşa komutasındaki kuşatma başarısız oldu.', emoji: '📉', kpssTip: 'Başarısızlık sonrası Kutsal İttifak kurulmuş, Osmanlı batıdan geriye doğru çekilmeye başlamıştır (Bu geri çekilme Sakarya Meydan Savaşı\'na kadar sürecektir).' },
    ]
  },
  {
    id: 'gerileme',
    ...
    events: [
      ...
      { id: 'g6', year: 1736, title: 'Osmanlı-Rus-Avusturya Savaşları', desc: 'Osmanlı\'nın gerileme devrinde hem Rusyayı hem Avusturyayı yenilgiye uğrattığı savaşlar.', emoji: '⚔️', kpssTip: 'I. Mahmut dönemi askeri ıslahatlarının (Humbaracı Ahmet Paşa) başarısını gösterir. Gerilemenin son başarılı savaş serisidir.' },
      { id: 'g7', year: 1739, title: 'Belgrad Antlaşması', desc: 'Gerileme döneminin en kazançlı antlaşması; Karadeniz son kez Türk gölü sayıldı.', emoji: '✍️', kpssTip: 'Fransa\'nın arabuluculuğu ile imzalanmıştır. Bu arabuluculuk nedeniyle Fransa\'ya verilen kapitülasyonlar 1740\'ta sürekli hale getirilmiştir (KPSS\'nin en çok sorduğu tuzak!).' },
      { id: 'g8', year: 1740, title: 'Kapitülasyonların Sürekliliği', desc: 'Fransa\'ya verilen kapitülasyon imtiyazları padişahın ömrüyle sınırlı olmaktan çıkarıldı.', emoji: '📜', kpssTip: 'I. Mahmut dönemidir. Belgrad arabuluculuğuna rüşvet olarak verilmiştir. Osmanlı ekonomisine vurulan en ağır darbelerden biridir.' },
      { id: 'g9', year: 1770, title: 'Çeşme Baskını ve Donanmanın Yakılması', desc: 'Rus donanması Baltık Denizi\'nden gelerek Çeşme limanında Osmanlı donanmasını yaktı.', emoji: '🔥', kpssTip: 'Osmanlı donanmasının tarihinde İKİNCİ kez yakılmasıdır (İlki İnebahtı, sonrakiler Navarin ve Sinop\'tur).' },
      { id: 'g10', year: 1774, title: 'Küçük Kaynarca Antlaşması', desc: 'Kırım bağımsız oldu; halifelik siyasi güç olarak ilk kez kullanıldı.', emoji: '📜', kpssTip: 'Tamamı Türk ve Müslüman olan bir toprak parçası (Kırım) ilk kez elden çıkmıştır. Padişah, Kırım halkıyla dini bağları korumak için HALİFELİK makamını siyasi amaçla ilk kez antlaşma metnine koydurmuştur. İlk kez tazminat ödenmiştir.' },
    ]
  },
  {
    id: 'dagilma',
    ...
    events: [
      ...
      { id: 'da3', year: 1829, title: 'Edirne Antlaşması', desc: 'Yunanistan\'ın bağımsızlığını ilan etmesiyle sonuçlanan antlaşma.', emoji: '📜', kpssTip: 'Osmanlı Devleti\'nden bağımsızlık kazanan İLK azınlık Rumlar (Yunanistan) olmuştur. Milliyetçiliğin yıkıcı etkisidir.' },
      { id: 'da4', year: 1839, title: 'Tanzimat Fermanı', desc: 'Kanun üstünlüğünü ve tüm vatandaşların eşitliğini ilan eden ferman.', emoji: '📜', kpssTip: 'Mustafa Reşit Paşa tarafından okunmuştur. Padişah ilk kez "Kanun Gücünün" üstünlüğünü kabul etmiştir. Anayasal düzene geçişin İLK adımıdır. Milliyetçilik isyanlarını önleme amacı taşır.' },
      { id: 'da5', year: 1853, title: 'Kırım Savaşı & İlk Dış Borç', desc: 'Rusya\'ya karşı İngiltere ve Fransa desteğiyle yapılan savaş sırasında ilk kez dış borç alındı.', emoji: '💸', kpssTip: 'Osmanlı tarihindeki İLK dış borcunu Kırım Savaşı sırasında Abdülmecit döneminde İngiltere\'den almıştır. Mali çöküşün ilk resmi adımıdır.' },
      { id: 'da6', year: 1856, title: 'Islahat Fermanı', desc: 'Paris Kongresi öncesi azınlıklara geniş haklar veren ferman.', emoji: '📜', kpssTip: 'Tamamen gayrimüslim tebaaya haklar tanımaya yöneliktir. Avrupalı devletlerin iç işlerimize karışmasını önlemek amacıyla Paris Antlaşması metnine eklenmiştir.' },
      { id: 'da7', year: 1876, title: 'I. Meşrutiyet & Kanun-i Esasi', desc: 'İlk anayasanın ilanı ve meclisli monarşiye geçiş dönemi.', emoji: '🏛️', kpssTip: 'Türk tarihinin İLK yazılı anayasası (Kanun-i Esasi) ilan edilmiş, halk ilk kez padişahın yanında yönetime ortak olmuştur (Rejim değişikliği).' },
      { id: 'da8', year: 1908, title: 'II. Meşrutiyet\'in İlanı', desc: 'İttihat ve Terakki baskısı sonucu anayasanın tekrar yürürlüğe girmesi.', emoji: '🏛️', kpssTip: 'Reval Görüşmeleri sonrası Jön Türkler ve İttihatçı subayların isyanıyla ilan edilmiştir. Çok partili hayata geçişin önünü açmıştır.' },
      { id: 'da9', year: 1911, title: 'Trablusgarp Savaşı', desc: 'İtalya\'nın sömürge arayışı sonucu saldırdığı Trablusgarp savunuldu.', emoji: '⚔️', kpssTip: 'Mustafa Kemal\'in İLK askeri başarısıdır. Derne ve Tobruk\'ta yerel halkı örgütlemiştir. Osmanlı Kuzey Afrika\'daki son toprağını kaybetmiştir.' },
      { id: 'da10', year: 1912, title: 'Balkan Savaşları', desc: 'Balkan devletlerinin birleşerek Osmanlı\'yı topraklarından atma savaşı.', emoji: '⚔️', kpssTip: 'Edirne dahil batı toprakları kaybedilmiş, büyük bir Türk göçmen dalgası Anadolu\'ya sığınmıştır. Türkçülük akımı güçlenmiştir.' },
      { id: 'da11', year: 1914, title: 'I. Dünya Savaşı\'na Giriş', desc: 'Osmanlı İmparatorluğu küresel savaşa ittifak bloklarında katıldı.', emoji: '🌍', kpssTip: 'Goben ve Breslau (Yavuz ve Midilli) gemilerinin Rus limanlarını bombalamasıyla savaşa girilmiştir. Padişah son kez Cihad ilan etmiştir.' },
      { id: 'da12', year: 1918, title: 'Mondros Ateşkes Antlaşması', desc: 'Anadolu topraklarını işgallere açan teslimiyet belgesi.', emoji: '📉', kpssTip: 'Osmanlı Devleti\'ni FİİLEN bitiren anlaşmadır. Özellikle 7. madde (güvenliği tehdit eden herhangi bir stratejik noktayı işgal hakkı) işgallerin hukuki kılıfı olmuştur.' },
    ]
  },
  {
    id: 'cumhuriyet',
    ...
    events: [
      { id: 'm1', year: 1919, title: 'Samsun Raporu (22 Mayıs)', desc: 'Mustafa Kemal\'in 9. Ordu Müfettişi olarak Samsun\'a çıktıktan sonra Harbiye Nezareti\'ne gönderdiği resmi rapor.', emoji: '📝', kpssTip: 'Milli Mücadele\'nin İLK resmi yazılı belgesidir. Rumların haksız olduğunu, Türklerin haklı davasını ve İzmir\'in işgalinin kabul edilemez olduğunu İstanbul\'a bildiren tarihi rapordur.' },
      { id: 'm2', year: 1919, title: 'Havza Genelgesi (28 Mayıs)', desc: 'Mustafa Kemal\'in milli bilinci uyandırmak için halkı işgalleri protesto etmeye çağırdığı genelge.', emoji: '📢', kpssTip: 'Milli Mücadele\'nin İLK genelgesidir. Halkı mitingler yapmaya ve işgalleri protesto telgrafları çekmeye davet ederek milli ruhu uyandırmıştır. Bu genelge sonrası Mustafa Kemal İstanbul\'a geri çağrılmıştır.' },
      { id: 'm3', year: 1919, title: 'Amasya Genelgesi', desc: 'Milli mücadelenin amacı, gerekçesi ve yönteminin ilk kez yayınlanması.', emoji: '📢', kpssTip: 'Milli Mücadele\'nin "İhtilal Beyannamesi"dir. "Milletin bağımsızlığını yine milletin azim ve kararı kurtaracaktır" maddesiyle üstü kapalı olarak milli egemenliğe ve rejim değişikliğine ilk kez işaret edilmiştir.' },
      { id: 'm4', year: 1919, title: 'Erzurum Kongresi', desc: 'Manda ve himayenin ilk kez reddedilerek ulusal sınırların çizilmesi.', emoji: '🤝', kpssTip: 'Toplanış bakımından bölgesel, aldığı kararlar bakımından ulusaldır. Manda ve himaye İLK kez reddedilmiştir. İlk kez geçici bir hükümet kurulmasından bahsedilmiştir.' },
      { id: 'm5', year: 1919, title: 'Sivas Kongresi', desc: 'Tüm yararlı cemiyetlerin tek bir çatı altında birleştirildiği kongre.', emoji: '🤝', kpssTip: 'Hem toplanış hem kararlar bakımından tamamen ULUSAL tek kongredir. Tüm cemiyetler "Anadolu ve Rumeli Müdafaa-i Hukuk Cemiyeti" adı altında birleştirilmiştir. Manda ve himaye KESİN olarak reddedilmiştir.' },
      { id: 'm6', year: 1920, title: 'TBMM’nin Açılması', desc: 'Ulusal egemenliği temsil eden kurucu meclisin Ankara\'da açılması.', emoji: '🏛️', kpssTip: 'Milli egemenlik ilkesi kurumsallaşmıştır. Kurucu ve olağanüstü yetkilere sahip bir meclistir. Meclis hükümeti sistemi uygulanmıştır.' },
      { id: 'm7', year: 1920, title: 'Sevr Antlaşması', desc: 'Milletimizce yırtılıp atılan, Saltanat Şurası onaylı ama hukuken geçersiz ölü doğmuş antlaşma.', emoji: '📉', kpssTip: 'Meclis-i Mebusan onayından geçmediği ve TBMM tarafından haince reddedildiği için hukuken geçersiz ölü doğmuş bir antlaşmadır.' },
      { id: 'm8', year: 1921, title: 'I. İnönü Savaşı', desc: 'Düzenli ordunun Batı cephesindeki ilk askeri zaferi.', emoji: '🎖️', kpssTip: 'Düzenli ordunun ilk zaferidir. Milat (Moskova Ant., İstiklal Marşı, Londra Konf., Afganistan Dostluk, Teşkilat-ı Esasiye anayasası) gelişmeleri bu zaferin ardından yaşanmıştır.' },
      { id: 'm9', year: 1921, title: 'Sakarya Meydan Muharebesi', desc: 'Geri çekilmenin bittiği tarihi zafer.', emoji: '🎖️', kpssTip: 'Mustafa Kemal\'e "Gazilik" unvanı ve "Mareşallik" rütbesi verilmiştir. II. Viyana Kuşatması\'ndan (1683) beri süregelen Türk geri çekilmesi bu zaferle son bulmuştur.' },
      { id: 'm10', year: 1922, title: 'Büyük Taarruz', desc: 'Düşmanın Anadolu topraklarından tamamen sökülüp atılması.', emoji: '⚔️', kpssTip: 'Kurtuluş Savaşı\'nın askeri safhası başarıyla tamamlanmış ve diplomatik safha (ateşkes süreçleri) başlamıştır.' },
      { id: 'm11', year: 1922, title: 'Mudanya Ateşkes Antlaşması', desc: 'Doğu Trakya, İstanbul ve Boğazlar\'ın savaşsız kurtarıldığı ateşkes.', emoji: '📜', kpssTip: 'Osmanlı Devleti\'nin HUKUKEN sona erdiğinin kanıtıdır; çünkü İtilaf Devletleri başkent İstanbul\'u Osmanlı yerine doğrudan TBMM hükümetine teslim etmiştir.' },
      { id: 'm12', year: 1922, title: 'Saltanatın Kaldırılması', desc: 'Laiklik yolundaki ilk büyük devrim.', emoji: '👑', kpssTip: 'Osmanlı Devleti resmen sona ermiştir. Lozan Konferansı\'nda İtilaf Devletleri\'nin ikilik çıkarma planı suya düşürülmüştür. Laikliğin ilk aşamasıdır.' },
      { id: 'm13', year: 1923, title: 'Lozan Barış Antlaşması', desc: 'Yeni Türk devletinin bağımsızlığının tüm dünyaca kayıtsız şartsız tanındığı tarihi barış belgesi.', emoji: '✍️', kpssTip: 'Yeni Türk Devleti\'nin kurucu tapu senedidir. Sevr antlaşması tamamen tarihe gömülmüştür. Kapitülasyonlar kesin olarak kaldırılmıştır.' },
      { id: 'm14', year: 1923, title: 'Cumhuriyetin İlanı', desc: 'Devletin adının konduğu ve rejim krizinin çözüldüğü gün.', emoji: '⭐️', kpssTip: 'Devlet başkanlığı krizi çözülmüş, ilk cumhurbaşkanı M. Kemal, ilk başbakan İsmet İnönü, ilk meclis başkanı Fethi Okyar olmuştur. Kabine sistemine geçilmiştir.' },
      { id: 'm15', year: 1924, title: 'Halifeliğin Kaldırılması', desc: 'Modernleşmenin hızlandığı laiklik devrimi.', emoji: '📜', kpssTip: 'Laiklik ve inkılapların önündeki en büyük engel kaldırılmıştır. Aynı gün Tevhid-i Tedrisat (eğitim birliği) kanunu kabul edilmiş ve Şer\'iye-Evkaf vekaleti kaldırılmıştır.' },
    ]
  }
];
