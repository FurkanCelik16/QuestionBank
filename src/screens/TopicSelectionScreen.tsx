...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  slotsRow: { flexDirection: 'row', gap: spacing.md, justifyContent: 'flex-start', marginBottom: spacing.xs, flexWrap: 'wrap' },
  slotWrapper: { width: '31%', minWidth: 100, maxWidth: 200, position: 'relative' },
  slotCard: { width: '100%', height: 90, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceLight, borderRadius: borderRadius.md, borderWidth: 1.5, borderColor: colors.border, padding: spacing.sm },
  ...
  slotName: { color: colors.textPrimary, fontSize: 10, fontWeight: '600', textAlign: 'center', flex: 1, marginBottom: 2 },
